...
public class FollowingPreferenceFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    //  (2) When a SharedPreference changes, check which preference it is and subscribe or
    ...
    //  (3) Make sure to register and unregister this as a Shared Preference Change listener, in
